...
**Project:** Warm Restaurant
**Generated:** 2026-03-18 20:07:52
...
| ---------- | --------- | -------------------- |
| Primary    | `#d1495b` | `--color-primary`    |
| Secondary  | `#00798c` | `--color-secondary`  |
| CTA/Accent | `#30638e` | `--color-cta`        |
| Background | `#faf9f9` | `--color-background` |
| Text       | `#003d5b` | `--color-text`       |
