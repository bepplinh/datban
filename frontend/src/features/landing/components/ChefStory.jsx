...
export default function ChefStory() {
  return (
    <section id="chef" className="section bg-background overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 max-w-[1200px] grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:gap-16">
        ...
        <motion.div 
          ...
          className="md:pl-16 mt-8 md:mt-0"
        >
          ...
          <div className="font-outfit text-4xl text-primary opacity-80 mt-8 font-semibold italic">
            Marco
          </div>
        </motion.div>
      </div>
